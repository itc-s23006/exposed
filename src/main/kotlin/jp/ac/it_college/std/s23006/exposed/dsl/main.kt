...
/*        println("----5.4.12----")
        val newUsers = listOf(
            ...
            User(106, "Rokurou", 13, "Hello")
        )
        val statement = UserTable.batchInsert(newUsers) { (id, name, age, profile) ->
        ...
        println("${updateCount}行のデータを更新しました")
